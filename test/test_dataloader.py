...
configurations = [
    {
        ...
        "event_desc": "Добро пожаловать на мероприятие. Тут будет много программирования и мало печенек. Не приходите тут невкусно.",
    ...
    },
    {
        ...
        "event_desc": "Техническая конференция для IT-специалистов. Они обязательно придут на данное мероприятие.",
    ...
    },
    {
        ...
        "logo": "./res/logo.webp",
        "logo_info": "HRTECH",
        "event_desc": "Как построить карьеру в IT? Сложно но возможно возможно. ",
    ...
    },
    {
        ...
        "logo": "./res/logo.webp",
        "logo_info": "AICOMPANY",
        "event_desc": "Будущее искусственного интеллекта. Оно уже наступило. Но вы его не смогете увидеть. Он восстанет.",
